...
BEGIN
  ...
  -- Ada tidaknya pilihan paket eksplisit untuk tugas ini. Bila KOSONG
  -- (mis. tugas lama dibuat sebelum fitur centang paket, atau admin
  -- sengaja tidak mencentang), fallback ke semua paket aktif milik
  -- owner supaya kolom Paket Request tidak "kosong" di halaman pegawai.
  SELECT EXISTS (
