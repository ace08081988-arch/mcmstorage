        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-ms-3">
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-ms-1.5 leading-none text-primary-foreground/85">
              ...
              <span className="inline-flex h-6 shrink-0 items-center gap-ms-1 whitespace-nowrap rounded-full bg-success/25 px-ms-2 text-ms-2xs font-semibold leading-none text-success ring-1 ring-success/50">
