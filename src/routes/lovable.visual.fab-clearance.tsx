...
/** Jarak aman bawah standar: gesture bar + bilah navigasi bawah + keyboard. */
const SAFE_BOTTOM =
  "calc(var(--app-safe-bottom, 0px) + var(--app-bottom-bar-space, 0px) + var(--app-keyboard-inset, 0px) + 1rem)";
