  ...
  return (
    <div className="dl-fade-up flex flex-col gap-ms-2">
      ...
      <button
        type="button"
        onClick={() => void openWa()}
        className="flex min-h-11 items-center justify-center gap-ms-1.5 rounded-lg bg-wa px-ms-3 text-ms-2xs font-semibold text-black transition-opacity hover:opacity-90"
