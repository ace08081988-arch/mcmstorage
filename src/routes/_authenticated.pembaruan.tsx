  ...
  return (
    <div className="mx-auto flex h-dvh max-w-2xl flex-col overflow-hidden bg-background [--chat-nav-h:calc(var(--ms-tap)+1.25rem+var(--app-safe-bottom,env(safe-area-inset-bottom,0px)))]">
      ...
      <button
        ...
        onPointerDown={onPressStart("light")}
        className={`app-hit-area fixed app-fab-bottom-stacked app-fab-right z-30 grid size-12 place-items-center rounded-full bg-muted text-foreground shadow-md hover:bg-muted/80 ${PRESS_FAB}`}
      >
      ...
      <Link
        ...
        onPointerDown={onPressStart("medium")}
        className={`app-hit-area fixed app-fab-bottom app-fab-right z-30 grid size-14 place-items-center rounded-2xl bg-primary text-primary-foreground shadow-lg hover:brightness-110 active:shadow-md ${PRESS_FAB}`}
      >
