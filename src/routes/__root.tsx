...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "MCM — aplikasi pengelola pesanan harian dengan foto, lokasi, dan kirim cepat via MCM." },
      ...
      { name: "twitter:description", content: "MCM — aplikasi pengelola pesanan harian dengan foto, lokasi, dan kirim cepat via MCM." },
    ...
    links: [
      ...
      { rel: "icon", href: "/icon-mcm.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/icon-mcm.png" },
    ],
  }),
