...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MCM Storage" },
      { name: "description", content: "MCM Storage u2014 kelola pesanan & kirim WA dalam satu aplikasi." },
      ...
      { property: "og:description", content: "MCM Storage u2014 kelola pesanan & kirim WA dalam satu aplikasi." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MCM Storage" },
      { name: "twitter:description", content: "MCM Storage u2014 kelola pesanan & kirim WA dalam satu aplikasi." },
