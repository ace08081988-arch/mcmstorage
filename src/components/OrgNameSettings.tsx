    ...
    <Card>
      <CardHeader className="space-y-1">
        <div className="flex items-center gap-ms-2">
          ...
          <CardTitle className="text-ms-base">Identitas & branding</CardTitle>
        </div>
        <CardDescription>
      ...
      <CardContent className="space-ms-4">
        ...
        <div className="space-ms-2">
          ...
          <div className="flex items-start gap-ms-3">
            ...
            <div className="flex flex-1 flex-wrap gap-ms-2">
              <input
                ref={fileRef}
                type="file"
              ...
              {!pendingLogo && savedLogo && (
                <Button
                  ...
                  className="gap-ms-1.5 text-destructive"
                >
          ...
          {pendingLogo && (
            <div className="rounded-md border border-warning/40 bg-warning/5 p-ms-2 text-ms-2xs">
              ...
              <div className="mb-2 grid grid-cols-2 gap-ms-2">
                <figure className="rounded-md border bg-muted/30 p-ms-1.5">
                  <div className="mb-1 flex items-center justify-between text-ms-2xs">
                ...
                <figure className="rounded-md border border-primary/60 bg-primary/5 p-ms-1.5 ring-1 ring-primary/40">
                  <div className="mb-1 flex items-center justify-between text-ms-2xs">
          ...
          {logoError && (
            <div
              role="alert"
              className="flex items-start gap-ms-2 rounded-md border border-destructive/40 bg-destructive/10 p-ms-2 text-ms-2xs text-destructive"
            >
              ...
              <button
                ...
                className="text-ms-2xs font-medium underline underline-offset-2 opacity-80 hover:opacity-100"
              >
                Tutup
              </button>
            </div>
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between gap-ms-2">
            ...
            <Button
              ...
              className="h-7 px-ms-2 text-ms-2xs gap-ms-1"
            >
        ...
        {/* Brand color */}
        <div className="space-ms-2">
          <Label className="flex items-center gap-ms-1.5">
          ...
          <div className="flex flex-wrap gap-ms-2">
            ...
            <button
              type="button"
              onClick={() => setBrand("")}
              className={`h-8 rounded-full border px-ms-3 text-ms-2xs font-medium ${
          ...
          <div className="flex items-center gap-ms-2 pt-1">
            ...
            <Input
              ...
              placeholder="#10b981"
              className="h-9 flex-1 font-mono text-ms-xs"
              maxLength={7}
            />
          </div>
          <p className="text-ms-2xs text-muted-foreground">
          ...
          <Button
            ...
            className="h-8 gap-ms-1.5 px-ms-2 text-ms-2xs"
          >
        ...
        <div className="space-ms-2">
          ...
          <div
            className="space-ms-3 rounded-lg border bg-muted/30 p-ms-3"
            style={brand ? ({ ["--primary" as any]: brand, ["--ring" as any]: brand } as React.CSSProperties) : undefined}
          >
            {/* Header sidebar */}
            <div className="rounded-md border bg-background p-ms-2.5">
            ...
            <div className="rounded-md border bg-background">
              <div className="px-ms-2.5 pt-2 text-ms-2xs font-medium uppercase tracking-wider text-muted-foreground">
                Footer publik
              </div>
              <div className="flex flex-col gap-ms-1 px-ms-2.5 pb-2.5 pt-1 text-ms-2xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
                <p>
                  © {new Date().getFullYear()}{" "}
                  <strong className="text-foreground">{full.trim() || DEFAULT_ORG_NAME}</strong>
                </p>
                <span className="text-ms-2xs">Syarat · Refund · Privasi</span>
              </div>
            </div>
            {/* Contoh tombol brand */}
            <div className="flex items-center gap-ms-2">
              <span className="text-ms-2xs font-medium uppercase tracking-wider text-muted-foreground">
                Aksen:
              </span>
              <button
                type="button"
                className="rounded-md bg-primary px-ms-3 py-1.5 text-ms-2xs font-medium text-primary-foreground shadow-sm"
              >
                Tombol utama
              </button>
              <span className="rounded-full border border-primary/40 bg-primary/10 px-ms-2 py-0.5 text-ms-2xs font-medium text-primary">
                Badge
              </span>
            </div>
          </div>
