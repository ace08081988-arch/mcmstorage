                ...
                <div className="min-w-0 flex-1">
                  <div className="font-semibold">
                    {effectiveDup.status === "in-flight"
                      ? (crossChannel
                          ? "Kiriman Ace untuk paket ini sedang berjalan."
                  ...
                  <dl className="mt-2 grid grid-cols-[auto,1fr] gap-x-2 gap-y-0.5 text-[11.5px]">
                    ...
                    <dd className="break-words">{effectiveDup.destination ?? data.conversationTitle}{crossChannel ? " · via Ace" : ""}</dd>
            ...
            <>
              ...
              {dupActive ? (
                <button
                  ...
                  title={
                    effectiveDup?.status === "in-flight"
                      ? (crossChannel ? "Kiriman Ace untuk paket ini masih berjalan" : "Kiriman sebelumnya masih berjalan")
                      : !payloadMatches
                ...
                <button
                  ...
                  title={live?.status === "in-flight" ? (crossChannel ? "Kiriman Ace untuk paket ini masih berjalan — tunggu selesai" : "Kiriman sebelumnya masih berjalan") : undefined}
