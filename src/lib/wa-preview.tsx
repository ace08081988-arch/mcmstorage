...
export function WaPreviewHost() {
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && finish(false)}>
      <DialogContent data-testid="wa-preview-dialog" className="flex max-h-[92svh] w-[calc(100vw-1.5rem)] max-w-md flex-col gap-0 overflow-y-hidden overflow-x-clip p-0 sm:max-h-[88svh] sm:w-full sm:max-w-md">
